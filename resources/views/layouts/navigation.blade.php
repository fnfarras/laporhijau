    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-3">
                ...
                @else
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm text-gray-500 hover:text-gray-700 font-semibold">{{ __('Log in') }}</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-sm text-gray-500 hover:text-gray-700 font-semibold">{{ __('Register') }}</a>
                        @endif
                    </div>
                @endauth
            </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            @else
                <div class="px-4 space-y-2">
                    <a href="{{ route('login') }}" class="block text-base font-semibold text-gray-600 hover:text-gray-800">{{ __('Log in') }}</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="block text-base font-semibold text-gray-600 hover:text-gray-800">{{ __('Register') }}</a>
                    @endif
                </div>
            @endauth
        </div>
