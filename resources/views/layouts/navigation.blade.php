        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
            ...
            @else
                <div class="px-4 space-y-2">
                    <a href="{{ route('login') }}" class="block text-base font-semibold text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white">{{ __('Log in') }}</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="block text-base font-semibold text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white">{{ __('Register') }}</a>
                    @endif
                </div>
            @endauth
        </div>
