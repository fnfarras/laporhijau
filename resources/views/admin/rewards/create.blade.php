                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="points_required" value="{{ old('points_required', 100) }}" required min="1"
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 @error('points_required') border-red-400 @enderror">
                    ...
                    <div>
                        ...
                        <select name="type" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 bg-white @error('type') border-red-400 @enderror">
