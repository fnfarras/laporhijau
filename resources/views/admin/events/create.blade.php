            ...
            <form method="POST" action="{{ route('admin.events.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" required
                              ...
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 resize-none @error('description') border-red-400 @enderror">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="datetime-local" name="event_date" value="{{ old('event_date') }}" required
                               class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 @error('event_date') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <select name="category" required class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-red-300 bg-white @error('category') border-red-400 @enderror">
